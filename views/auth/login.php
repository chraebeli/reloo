...
<div class="row justify-content-center">
  <div class="col-md-6">
    <div class="card p-4">
      ...
      <form method="post" action="<?= e(rtrim($config['app']['base_path'], '/')) ?>/login">
        <?= csrf_field() ?>
      ...
      <a class="small mt-3" href="<?= e(rtrim($config['app']['base_path'], '/')) ?>/register">Noch kein Konto? Jetzt registrieren</a>
    </div>
  </div>
</div>
